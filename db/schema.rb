...
ActiveRecord::Schema.define(version: 20_201_123_033_359) do
  ...
  create_table 'reviews', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['shop_id', 'created_at'], name: 'index_reviews_on_shop_id_and_created_at'
    t.index ['shop_id'], name: 'index_reviews_on_shop_id'
    t.index ['user_id', 'created_at'], name: 'index_reviews_on_user_id_and_created_at'
    t.index ['user_id'], name: 'index_reviews_on_user_id'
  end

  create_table 'shop_tag_relations', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci', force: :cascade do |t|
    t.bigint 'shop_id', null: false
